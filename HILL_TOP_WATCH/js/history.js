...
//     }else{
//       s = '<li id="tendangnhapuser" onclick="window.location.href=\'index.html\'">'+'<i class="fas fa-user"></i>'+user.username+'</li>'+
//           '<li id="history" onclick="window.location.href =\'orderhistory.html\'"><i class="fas fa-shopping-cart" style="margin-right:13px;"></i>Lịch sử</li>'+
//           '<li id="dangxuat" onclick="logOut(\'index.html\');"><i class="fas fa-sign-out-alt" style="margin-right:10px;"></i>LOG OUT</li></li></ul>'+
//           '<li id="taikhoanuser" class="tooltip"><a href="#" onclick="openLogOut();" class="hra"><i class="fas fa-caret-down" style="background-color: #6e6b67;"></i></a><span class="tooltiptext tooltiptk" id="tooltiptk">Tài khoản</span></li>';
//           document.getElementById('user').style.display = 'none';
...
//       if(cartArray[i].productId==product[i].productId )
//       {
//         tensp+= product[i].name;
...
//     var billArray = [];
//     bill = {tensp:tensp,hoten:userloginArray.hoten,idkh:userloginArray.username,id:(billArray.length+1), totalprice: totalprice , date: d, status: 'Chưa xử lý',diachi:userloginArray.address,sdt:userloginArray.phone};
...
//     document.getElementById('null').innerHTML = 'Không có sản phẩm nào được đặt';
//   }
//   else{
//     var billArray = JSON.parse(localStorage.getItem('bill'));
...
//       if(userloginArray.hoten==billArray[i].hoten){
